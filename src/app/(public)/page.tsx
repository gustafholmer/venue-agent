...
export default async function LandingPage() {
  ...
  return (
    <div>
      ...
      {/* How the agent works */}
      <section className="border-t border-[#e7e5e4] bg-[#f5f3f0]">
        <div className="px-4 sm:px-6 py-12 sm:py-16">
          <p className="text-sm uppercase tracking-widest text-[#78716c] mb-6">
            Så fungerar agenten
          </p>
          <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr_auto_1fr] gap-8 md:gap-6 items-start">
            <div>
              ...
              <p className="text-[#c45a3b] text-sm mb-2">01</p>
              <h3 className="text-[#1a1a1a] font-medium mb-2">Beskriv ditt event</h3>
            ...
            <div className="hidden md:flex items-center justify-center h-20 px-2">
              <svg width="80" height="20" viewBox="0 0 80 20" fill="none" className="text-[#c45a3b] opacity-50 w-full">
            ...
            <div>
              ...
              <p className="text-[#c45a3b] text-sm mb-2">02</p>
              <h3 className="text-[#1a1a1a] font-medium mb-2">Få personliga förslag</h3>
              <p className="text-[#78716c] text-sm leading-relaxed">
            ...
            <div>
              ...
              <p className="text-[#c45a3b] text-sm mb-2">03</p>
              <h3 className="text-[#1a1a1a] font-medium mb-2">Boka direkt</h3>
              <p className="text-[#78716c] text-sm leading-relaxed">
        ...
        <div className="px-4 sm:px-6 py-12 sm:py-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="max-w-xl">
              <p className="text-sm uppercase tracking-widest text-[#78716c] mb-4">
                För lokalägare
              </p>
              <h2 className="text-2xl sm:text-3xl text-[#1a1a1a] mb-4">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 text-[#1a1a1a] font-medium underline underline-offset-4 hover:text-[#c45a3b] transition-colors"
              >
                Kom igång
