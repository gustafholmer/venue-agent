...
export default function SavedVenuesPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-semibold text-[#111827]">Sparade lokaler</h1>
      ...
      {!isLoading && !error && savedVenues.length === 0 && (
        <div className="bg-white border border-[#e5e7eb] rounded-xl p-12 text-center">
          ...
          <h3 className="text-lg font-medium text-[#111827] mb-2">Inga sparade lokaler</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {savedVenues.map((savedVenue) => {
            ...
            return (
              <div
                key={savedVenue.id}
                className="bg-white border border-[#e5e7eb] rounded-xl overflow-hidden hover:shadow-lg transition-all group"
              >
