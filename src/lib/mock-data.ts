...
export const MOCK_VENUES: (Venue & { primaryPhotoUrl?: string | null })[] = [
  ...
  },
  {
    ...
    description: 'Moderna konferenslokaler i centrala Stockholm med allt från mindre mötesrum till stora konferensalar. Perfekt för moten, utbildningar och workshops med professionell service och teknik.',
