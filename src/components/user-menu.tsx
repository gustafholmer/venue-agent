  ...
  return (
    <div ref={menuRef} className="relative">
      <button
        ...
        className={`inline-flex items-center gap-1.5 text-sm font-medium px-4 py-1.5 rounded-full text-white transition-colors shadow-sm ${isOnDashboard ? 'bg-[#7b4a6b] hover:bg-[#65395a]' : 'bg-[#c45a3b] hover:bg-[#a84832]'}`}
      >
