  ...
  if (isUser) {
    return (
      <div className="flex justify-end">
        <div className="max-w-[90%] bg-[#c45a3b] text-white rounded-2xl rounded-br-md px-3 py-2 inverted-selection">
...
function LoadingIndicator() {
  return (
    <div className="flex justify-start">
      <div className="bg-[#f5f3f0] rounded-2xl rounded-bl-md px-3 py-2">
